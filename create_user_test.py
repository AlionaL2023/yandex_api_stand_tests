...
def negative_assert_no_first_name(user_body):
    ...
    # Проверяется, что код ответа равен 400
    assert user_response.status_code == 400
    # Проверяется, что в теле сообщения записывается код ошибки 400
    assert user_response.json()["code"] == 400
...
# Тест 3. Негативная проверка, пользователь не создан
# Параметр fisrtName состоит из 1 символа
def test_create_user_1_letter_in_first_name_get_error_response():
        negative_assert_symbol("A")

# Тест 4. Негативная проверка, пользователь не создан
...
# Параметр fisrtName состоит из латинских букв заглавных и строчных
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")

# Тест 6. Успешное создание пользователя
# Параметр fisrtName состоит из русских букв заглавных и строчных
def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Мария")

# Тест 7. Негативная проверка, пользователь не создан
# Параметр fisrtName состоит из русских букв с пробелами
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")

# Тест 8. Негативная проверка, пользователь не создан
# Параметр fisrtName состоит из символов
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")

# Тест 9. Негативная проверка, пользователь не создан
# Параметр fisrtName состоит из цифер
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")

# Тест 10. Негативная проверка, пользователь не создан
